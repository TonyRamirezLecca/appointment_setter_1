...
public class PatientAddController implements Initializable {
    ...
    @FXML public void addPatientHandler(ActionEvent event) throws IOException {
        if (state.getSelectionModel().getSelectedItem() != null) {
            ...
            if (errorHandler(patientName, patientInsurance, patientAddress1, patientAddress2, patientCity, patientState, patientPostalCode, patientPhone)) {
                DatabasePatient.addPatient(patientName, patientInsurance, patientAddress1, patientAddress2, patientCity, patientState, patientPostalCode, patientPhone);
            ...
            loginError.setContentText("Please fill out all sections of form. (Address 2 is optional)");
